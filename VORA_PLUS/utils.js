...
function(a, e) {
  ...
  , wasPlayed = function(e, a) {
    a.querySelectorAll(".playedOverlay").forEach(a => a.remove());
    let n = document.createElement("div");
    n.classList.add("playedOverlay"),
  ...
  , setTmdbLanguage = function(a) {
    localStorage.setItem("tmdb-language", a || "en-US")
}
  , getTmdbImageQuality = function() {
    return localStorage.getItem("tmdb-image-quality") || "w500"
}
  , setTmdbImageQuality = function(a) {
    localStorage.setItem("tmdb-image-quality", a || "w500")
};
